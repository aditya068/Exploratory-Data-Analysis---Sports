...
Original file is located at
    https://colab.research.google.com/drive/1KgqJD0mjz15B8pECnJ8U4lbKNVmdqPEE
...
merge.groupby('batsman')['batsman_runs'].sum().sort_values(ascending = False).head(10).plot(kind = 'bar', color = 'indigo',
                                                                                            figsize = (15,5))
